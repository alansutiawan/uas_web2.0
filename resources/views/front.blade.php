...
<style>
    body{
        background-image: url('images/shop1.jpeg');
        background-size: 100%;
    }
</style>
</head>
...
<div class="center-container">
			...
			<div class="w3_agile_header">
						<div class="w3_agileits_logo" style="width: 1000px; padding-bottom: 20px;font-size: 70px">
                             <center>
                            <a class="brand" href="">SPORT CENTER</a>
                            </center>
							</div>
							<div class="w3_menu">
    ...
    <div id="app">
      <nav class="navbar navbar-expand-md navbar-blue bg-light sticky-top ">
    ...
    <div class="copyright">
	           <p>© 2019 SHOOPING ID. All rights reserved | Design by Syarif Anggraeni</p>
    </div>
